...
<div class="wrapper row3">
	...
	<div style="margin: 0 auto; width: 340px;text-align:left;"> <br>
		<form action="#" method="post">
			...
			<div class="MyContainer">
			<div class="g-recaptcha" data-sitekey="6Ldh-RkTAAAAAPtk9mzLYazqa7A9twsF8-2dMPuC">
				</div>
			</div>
			
			<div  class="MyContainer" style="text-align:center">
			    <small>Clicking Create account means that you agree to <br>
				our <a href="Register.html" title="Services Agreement">Services Agreement</a> and <a href="Register.html">Privacy Policy</a><br><br></small>
