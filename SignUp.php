...
<div class="container">
	...
	<form role="form" action="SignUp.php" method="post">
		...
		<div class="form-group">
			...
			<input type="email" name="email" id="email" value="<?php echo @$_POST["email"]; ?>" class="form-control" onBlur="valEmail(this,Validate_email)" required autocomplete="on">
		...
		<div class="form-group">
			...
			<input type= "tel" name="PhoneNo" id="PhoneNo" value="<?php echo @$_POST["PhoneNo"]; ?>" class="form-control" onBlur="valPhoneNo(this,Validate_PhoneNo)" autocomplete="on">
